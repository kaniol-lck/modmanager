...
class LocalModBrowser : public Browser
{
    Q_OBJECT
public:
    enum { ModColumn, NameColumn, IdColumn, VersionColumn, EnableColumn, StarColumn, FileDateColumn, FileSizeColumn, CurseforgeIdColumn, ModrinthIdColumn, DescriptionColumn };
